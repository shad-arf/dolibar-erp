...
llxHeader("", "https://wiki.patas-monkey.com/index.php?title=MyList", $langs->trans("Mylist"));
...
if ($lists != -1) {
	...
	foreach ($lists as $list) {
		...
		print "<tr >\n";
		$dt="";
		if ($list['datatable'] == 1) $dt="dt";
		print "<td><a href='mylist".$dt.".php?rowid=".$list['rowid']."'>".$list['label']."</a></td>\n";
		print "<td align='left'>";
		print $langs->trans($list['mainmenu'])." / ".$langs->trans($list['leftmenu'])." / ".$list['titlemenu'];
		print "</td>\n";
		print "</tr>\n";
	}
	print '</tbody>';
