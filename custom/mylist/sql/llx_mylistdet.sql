...
(
	...
	rang			integer NULL DEFAULT NULL, 			-- position du champ ds le tableau
	...
	widthpdf		integer NULL DEFAULT NULL ,			-- Largeur du champs dans l'édition pdf
	sumreport		integer NULL DEFAULT NULL ,			-- totalise la valeur du champ
	pctreport		integer NULL DEFAULT NULL ,			-- pourcentage la valeur du champ
	avgreport		integer NULL DEFAULT NULL ,			-- moyenne la valeur du champ
	cumreport		integer NULL DEFAULT NULL ,			-- cumul de la valeur du champ
	cumpctreport	integer NULL DEFAULT NULL ,			-- cumul de pourcentage
	barcode			integer NULL DEFAULT NULL ,			-- type de codebarre
	filterinit		varchar(255)  NULL DEFAULT NULL ,	-- filtrage/valeur  par défaut
	updatekey		varchar(255)  NULL DEFAULT NULL
	 	-- clé pour la mise à jour
)ENGINE=innodb;