-- ===================================================================
-- Copyright (C) 2013-2020	Charlie Benke	<charlie@patas-monkey.com>
--
...
(
	...
	datatable	integer NULL DEFAULT 0 ,			-- la liste s'affiche avec datatable ou non
	shownumline integer NULL DEFAULT 0 ,			-- ajoute un numéro en début de ligne
	categories	varchar(10) NULL DEFAULT NULL ,		-- catégories à utiliser pour le filtrage
	model_pdf	varchar(255) NULL DEFAULT NULL
		-- modèle d'édition dédié
)ENGINE=innodb;	
