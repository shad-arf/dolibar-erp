<?php /* Smarty version 2.6.26, created on 2022-02-17 17:59:21
...
<?php echo '/jquery.dataTables.js"></script>
	<script type="text/javascript" src="'; ?>
<?php echo $this->_tpl_vars['JSPATH']; ?>
<?php echo '/moment.js"></script>
	<script type="text/javascript" src="'; ?>
<?php echo $this->_tpl_vars['JSPATH']; ?>
<?php echo '/datetime-moment.js"></script>
'; ?>
...
>CSV
											<INPUT type="radio" id="rpt_format_xls" name="target_format" value="XLS" <?php echo $this->_tpl_vars['OUTPUT_TYPES'][3]; ?>
>XLS
...
<?php if ($this->_tpl_vars['SHOW_HIDE_PREPARE_XLS_BUTTON'] == 'show'): ?>
    				<input type="submit" class="<?php echo $this->_tpl_vars['BOOTSTRAP_STYLE_TOOLBAR_BUTTON']; ?>
prepareAjaxExecute swXLSBox" title="<?php echo $this->_tpl_vars['T_PRINT_XLS']; ?>
